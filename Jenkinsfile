...
stage ('Code cloning') {
 ...
 sleep 5 
  ...
  stage ('Create Docker Container') {
   ...
   sh 'ssh -p2244 pkbot@pkbotnode docker -H  tcp://192.168.10.235:2376 run -d -p 6379 --name hubot -v hubotvolume:/home/hubot/pkbot --entrypoint /bin/bash /home/hubot/pkbot/run.sh hubotimage'
		    }
}
